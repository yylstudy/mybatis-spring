...
public final class SqlSessionUtils {
  ...
  public static SqlSession getSqlSession(SqlSessionFactory sessionFactory, ExecutorType executorType, PersistenceExceptionTranslator exceptionTranslator) {
    ...
    /**根据SimpleExecutor获取DefaultSqlSession，这里需要注意的是
     * 一个属性，那就是在SimpleExecutor中的Transaction对象不是JdbcTransaction了，而是
     * SpringManagedTransaction，这个很重要，后面获取Connection是通过这个SpringManagedTransaction获取的
     * 这样就和pring的事务关联上了
     * */
